...
<body>
    ...
    <div class="container text-warning davide">
        <form action="" method="post">
            <div>
                <h1 style="color:#ffc107;" :>Bonifico</h1>
            </div>
            <div class="form-group w-75 centrare">
                <label for="ibanDest" style="color:#ffc107;">Inserisci conto corrente del destinatario:</label><br>
                <input type="text" id="ibanDest" name="ibanDest" autocomplete="off"
                    placeholder="IT 99 C 12345 67890 123456789012" required style="background-color:#dda74f;">
            </div>
            <div class="form-group w-75 centrare">
                <label for="importo" style="color:#ffc107;">Inserisci importo del bonifico:</label><br>
                <input type="text" id="importo" name="importo" autocomplete="off" required
                    style="background-color:#dda74f;">
            </div>
            <div>
            ...
            <div class="form-group w-75 centrare">
                <input type="submit" id="Invio" name="Invio" value="Effettua bonifico"
                    class="btn btn-default glow-button" style="background-color:#d4c03d;">
            </div>
        </form>
    </div>
    <?php
    ...
    {
        echo ("<div class= 'container text-warning davide'>");
        echo ('<form method="post" action="">');
        echo ("<div class='form-group w-75 centrare'><label for='lCodice'>Inserisci il codice ricevuto via mail:</label><br>");
        echo ("<input type='text' name='codiceConferma' id='lCodice' autocomplete='off' placeholder='codice' required style='background-color:#dda74f;'></div><br>");
        echo ("<div><input type='submit' name='Conferma' value='Conferma' class='btn btn-default glow-button' style='background-color:#d4c03d;'></div>");
        echo ("</form>");
        echo ("</div>");
