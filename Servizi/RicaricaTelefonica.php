...
if (isset($_POST['Invio']) && $_SESSION['Importo'] != "" && $_SESSION['Operatore'] != "") {
    ...
    if ($saldo >= $importo) {
        ...
        $messaggio .= " Il tuo saldo attuale è " . $saldoRestante."€";
        ...
        $messaggio = "Il tuo saldo è negativo.";
    }
    $importo = 0;
    $operatore = "";
    $conn->close();
...
<body>
    ...
    <div class="container text-warning davide">
        ...
        <form method="post" action="">
            ...
            <select id="Operatore" name="Operatore" style="background-color:#dda74f;">
                <option value=""></option>
            ...
            <select id="Importo" name="Importo" style="background-color:#dda74f;">
                <option value=""></option>
            ...
            <input type="submit" name="Invio" value="Invio"  class="btn btn-default glow-button" style="background-color:#d4c03d;"/>
        </form>
    </div>

        <?php 
        if($_SESSION["ErroreImporto"]!="")
        {
            $oh=$_SESSION["ErroreImporto"];
            echo ("<script>document.getElementById('errore').style.display='block'; document.getElementById('errore').innerHTML='';document.getElementById('errore').innerHTML='$oh';</script>");
        }
        if($_SESSION["ErroreOperatore"]!="")
        {
            $oh=$_SESSION["ErroreOperatore"];
            echo ("<script>document.getElementById('errore').style.display='block'; document.getElementById('errore').innerHTML='';document.getElementById('errore').innerHTML='$oh';</script>");
        }
        if($messaggio!=""){
        
            echo ("<script>document.getElementById('info').style.display='block'; document.getElementById('info').innerHTML='';document.getElementById('info').innerHTML='$messaggio';</script>"); 
         }
